...
ylabel('Change in \# Channel Access [\%]');
...
saveas(fig,['../figures/ctrl_data_channel_access_percentage_v' version '.png']);
saveas(fig,['../figures/ctrl_data_channel_access_percentage_v' version '.fig']);
saveas(fig,['../figures/ctrl_data_channel_access_percentage_v' version '.eps'], 'epsc');