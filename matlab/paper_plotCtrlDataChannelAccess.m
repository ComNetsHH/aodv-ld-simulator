...
[pdrEastAodv_l, pdrEastAodv_m, pdrEastAodv_h] = getCI(getCtrlDataChannelAccess('east', 'aodv', version));
[pdrEastAodvLdD_l, pdrEastAodvLdD_m, pdrEastAodvLdD_h] = getCI(getCtrlDataChannelAccess('east', 'aodv-ld-d', version));
[pdrEastAodvLdS_l, pdrEastAodvLdS_m, pdrEastAodvLdS_h] = getCI(getCtrlDataChannelAccess('east', 'aodv-ld-s', version));
[pdrWestAodv_l, pdrWestAodv_m, pdrWestAodv_h] = getCI(getCtrlDataChannelAccess('west', 'aodv', version));
[pdrWestAodvLdD_l, pdrWestAodvLdD_m, pdrWestAodvLdD_h] = getCI(getCtrlDataChannelAccess('west', 'aodv-ld-d', version));
[pdrWestAodvLdS_l, pdrWestAodvLdS_m, pdrWestAodvLdS_h] = getCI(getCtrlDataChannelAccess('west', 'aodv-ld-s', version));
...
saveas(fig,['../figures/ctrl_data_channel_access_v' version '.png']);
saveas(fig,['../figures/ctrl_data_channel_access_v' version '.fig']);
saveas(fig,['../figures/ctrl_data_channel_access_v' version '.eps'], 'epsc');